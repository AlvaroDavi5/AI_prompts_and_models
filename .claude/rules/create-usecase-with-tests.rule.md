---
description: This file describes the rules for creating a new NestJS usecase and its unit test file. Enforces project test structure, mock patterns, scenario coverage (success, failure, exceptions), and NestJS TestingModule setup.
paths: [
  "src/**/*.ts",
  "src/**/*js",
  "tests/**/*.ts",
...
Use when implementing a new NestJS usecase and its unit test file. Enforces project test structure, mock patterns, scenario coverage (success, failure, exceptions), and NestJS TestingModule setup.
