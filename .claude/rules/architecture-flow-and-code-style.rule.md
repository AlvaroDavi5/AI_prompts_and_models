---
description: This file describes the architecture flow and code style rules for the project. Enforces trigger -> logic_provider -> data_provider flow, provider responsibilities, naming conventions, immutability, and clean code practices.
paths: [
  "src/**/*.ts",
  "src/**/*js",
  "scripts/**/*.ts",
