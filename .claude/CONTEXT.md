...
Architecture rules, layer definitions, naming conventions, and code quality hard rules are defined in [`architecture-flow-and-code-style.rule.md`](./rules/architecture-flow-and-code-style.rule.md).
