...
Follow the principles of testing in project documentation:
...
All unit test patterns, mock rules, describe label format, scenario groups, exception assertion pattern, and scenarios to cover are defined in [`create-usecase-with-tests.rule.md`](./../rules/create-usecase-with-tests.rule.md) — follow them strictly.
